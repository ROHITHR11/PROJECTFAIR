      ...
      <div className='mt-4' >
        { allProjects.length>0? allProjects.map((project,index)=>(
          ...
          <div className='icons d-flex align-items-center'>
            ...
            <a href={project?.github} target='_blank' className='btn btn-link ms-2'><i style={{height:'34px'}} 
            className='fa-brands fa-github fa-2x'></i></a>
            <button  onClick={()=>handleDeleteProject(project._id)} className='btn btn-link text-danger ms-2'><i style={{height:'34px'}} 
