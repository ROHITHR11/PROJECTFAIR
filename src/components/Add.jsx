 ...
 const {addResponse,setAddResponse} = useContext(addResponseContext)
  ...
  return (
    ...
    <button onClick={handleShow} style={{textDecoration:'none'}} className='btn btn-link text-warning d-flex align-items-center fw-bolder'>
      <i style={{height:'34px'}}
     className='fa-solid fa-plus fa-2x me-2'></i>Add Project</button>
     <Modal size='lg'
        show={show}
        onHide={handleClose}
        backdrop="static"
      ...
      >
         ...
         <div className='row'>
          <div className='col-lg-4'>
            <label  className='w-100 d-flex align-items-center flex-column justify-content-center'>
              ...
              <img height={'200px'} width={'200px'} className='mt-5' src={preview?preview:uploadProject} alt="Project upload pic" />
            </label>
             {!imageFileStatus&& <div className='text-danger'> *Upload only the following file types(jpg.jpeg,png)*
          </div>}
          </div>
        ...
        <Modal.Footer>
          ...
          <Button  variant="success" onClick={handleProjectUpload} >Save</Button>
        </Modal.Footer>
      </Modal>
